...
const Result: CustomNextPage = (sliderValues: any) => {
  ...
  async function callLambdaFunction() {
    const response = await fetch(
      "https://e5vsx4lon0.execute-api.us-east-1.amazonaws.com/prod",
      {
        method: "POST",
        headers: {
  ...
  const syllabusComponents: any = {
    ...
    textbook: {
      ...
      score: 100,
      summary:
        "This book is the exact same as the other one since no one can resist books written by Manasi Patil.",
    },
    gradingScheme: {
      gradingScheme: {
        A: 93,
