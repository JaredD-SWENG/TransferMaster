...
const ParentCardPsuUpload: React.FC<ParentCardProps> = ({
  title,
  onExtractedData,
  userID,
  footer,
...
const ParentCardExtUpload: React.FC<ParentCardProps> = ({
  title,
  onExtractedData,
  userID,
  footer,
...
const PreEvaluate: React.FC<SyllabusProps> = ({
  course,
  credits,
  textbook,
  learningObjectives,
  ...
  const handleExtExtractedData = (data: {
    course: any;
  ...
  const handlePsuExtractedData = (data: {
    course: any;
    credits: React.SetStateAction<number>;
    textbook: any;
    learningObjectives: any;
  ...
  return (
    <PageContainer>
      ...
      <Grid item xs={12}>
        ...
        <HoverButton
          instructions="This is the pre-evaluation page.'
            Upload a PSU and an external syllaus to find the possibility of your external course transfering in "
        />
      </Grid>
      <Grid container spacing={3} mt={3}>
        <Grid item xs={12} lg={6}>
          <ParentCardPsuUpload
            title="Penn State"
            onExtractedData={handlePsuExtractedData}
            userID={userID}
          >
            <SyllabusForm
        ...
        <Grid item xs={12} lg={6}>
          <ParentCardExtUpload
            title="External School"
            onExtractedData={handleExtExtractedData}
            userID={userID}
          >
            <SyllabusForm
