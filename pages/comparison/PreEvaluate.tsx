        ...
        <CardHeader
          title={
            <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
              <Box sx={{ flexGrow: 1 }}>{title}</Box>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: -4.3, mt: -1 }}>
                <ExtUploadPopupPreeval onExtractedData={onExtractedData} userID={userID} />
              </Box>
            </Box>
          }
        />
...
{/**SyllabusComparison */}
const PreEvaluate: React.FC<SyllabusProps> = ({ course, credits, textbook, learningObjectives}) => {
    ...
    return (
        <PageContainer>
            ...
            <HoverButton instructions="This is the pre-evaluation page.'
