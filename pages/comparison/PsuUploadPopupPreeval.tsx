...
const PsuUploadPopupPreeval: React.FC<UploadPopupProps> = ({
  onExtractedData,
  userID,
}) => {
          ...
          loadingTask.promise
            .then(
              async (pdf: {
                ...
                // Loop through each page and extract text (pdf.numPages)
                ...
                try {
                  ...
                  if (
                    ...
                    userDocSnapshot.data().MyUploads
                  ) {
                    ...
                    console.log(
                      "Created MyUploads[] and added the syllabus ref to it"
                    );
                  }
