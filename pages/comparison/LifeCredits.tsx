...
const ParentCardResumeUpload: React.FC<ResumeCardProps> = ({
  title,
  onExtractedData,
  userID,
}) => {
...
const LifeCredits: React.FC<SyllabusProps> = ({
  course,
  credits,
  textbook,
  learningObjectives,
  ...
  async function callLambdaFunction() {
    ...
    try {
      const response = await axios.post(
        "https://ubho2cbmax336g6ll6efz55nwi0iniar.lambda-url.us-east-1.on.aws/",
        {
          psuText: psuFullText,
  ...
  return (
    <PageContainer>
      ...
      <Grid item xs={12} mt={3} mb={3}>
        ...
        <HoverButton
          instructions="This is the Life Credits page.
